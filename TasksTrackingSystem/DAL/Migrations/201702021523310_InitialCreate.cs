    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TaskDBs", t => t.Task_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.HistoryDBs", "Task_Id", "dbo.TaskDBs");
            DropForeignKey("dbo.TaskDBs", "Project_Id", "dbo.ProjectDBs");
            DropForeignKey("dbo.TaskDBs", "CurrentUser_Id", "dbo.UserDBs");
            DropForeignKey("dbo.TaskDBs", "Category_Id", "dbo.CategoryDBs");
            DropForeignKey("dbo.TaskDBs", "Author_Id", "dbo.UserDBs");
            ...
            DropIndex("dbo.TaskDBs", new[] { "Project_Id" });
            DropIndex("dbo.TaskDBs", new[] { "CurrentUser_Id" });
            DropIndex("dbo.TaskDBs", new[] { "Category_Id" });
            DropIndex("dbo.TaskDBs", new[] { "Author_Id" });
